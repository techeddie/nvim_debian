...
--BUFFER OPEN CLOSE 
  ...
  keymap("n", "<leader>sn", ":set nonumber<CR>") --nolinenumbers
  keymap("n", "<leader>snn", ":set nonumber<CR>") --nolinenumbers
  ...
  keymap("n", "<leader>t", ":FloatermNew<CR>") --open new terminal
...
--FILE MANAGEMENT
  ...
  keymap("n", "<leader>m", ":Startify <CR>") --welcome screen
...
--LAZYGIT
  ...
  keymap("n", "<leader>gg", ":LazyGitCurrentFile<CR>") --lazygit
